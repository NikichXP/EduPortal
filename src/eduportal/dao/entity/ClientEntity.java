...
public class ClientEntity extends UserEntity {
	...
	public void setCreator(Employee emp) {
		creator = emp.id;
		if (curator == null) {
			this.curator = Ref.create(emp).getKey();
		}
	}

	public Employee getCurator() {
		return ((curator != null) ? Ref.create(curator).get() : null);
	}

	public void setCurator(Employee emp) {
		curator = Ref.create(emp).getKey();
	}
	
	public void setCurator(UserEntity emp) {
